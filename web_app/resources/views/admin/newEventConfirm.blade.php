...
<div class="container">
    <div class="row justify-content-start">
        <div class="col-md-10">
            <h1>{{__('messages.newEventConfirm')}}</h1>
            <div id="eventDetails">
                <form method="POST" action="{{ route('new-event-confirm.submit') }}" accept-charset="utf-8" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input disabled id="short_description" type="text" class="form-control @error('short_description') is-invalid @enderror" name="short_description" value="{{$event_session['short_description']}}" autocomplete="short_description">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input disabled id="capacity" type="number" class=" form-control @error('capacity') is-invalid @enderror" name="capacity" value="{{$event_session['capacity']}}" autocomplete="capacity">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input disabled id="capacity" type="number" class=" form-control @error('min_price') is-invalid @enderror" name="min_price" value="{{$event_session['min_price']}}" autocomplete="min_price">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input disabled id="max_price" type="number" class=" form-control @error('max_price') is-invalid @enderror" name="max_price" value="{{$event_session['max_price']}}" autocomplete="max_price">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input disabled id="show_location_map" type="checkbox" @if(isset($event_session["show_location_map"])) checked @endif class="form-check-input @error('is_time_set') is-invalid @enderror" name="is_time_set" autocomplete="is_time_set" />
                    ...
                    @endif
                    @if(isset($event_session["media_alt"]))
                    <div class="row mb-3">
                        <label for="media_alt" class="col-md-4 col-form-label text-md-end">{{ __('messages.eventMediaAlt') }}</label>

                        <div class="col-md-6">
                            <textarea disabled id="media_alt" type="text" class="form-control @error('media_alt') is-invalid @enderror" name="media_alt" autocomplete="media_alt">{{$event_session['media_alt']}}</textarea>
                    ...
                    <div class="row mb-0">
                        <div class="col-md-8 offset-md-4">
                            <a href="{{ route('new-event.view') }}" aria-label="{{__('messages.previous')}}" class="btn btn-secondary me-2">
